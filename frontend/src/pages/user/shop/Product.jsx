                                ...
                                <ul className="nav nav-tabs" role="tablist">
                                    <li className="nav-item">
                                        <a className="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                            <div className="product__thumb__pic " style={{
							backgroundImage:
                                ...
                                <div className="tab-content">
                                    <div className="tab-pane active" id="tabs-1" role="tabpanel">
                                        <div className="product__details__pic__item">
                                            <img src="src/assets/img/shop-details/product-big-2.png" alt=""/>
                                        </div>
                                    </div>
                                    <div className="tab-pane" id="tabs-2" role="tabpanel">
                                        <div className="product__details__pic__item">
                                            <img src="src/assets/img/shop-details/product-big-3.png" alt=""/>
                                        </div>
                                    </div>
                                    <div className="tab-pane" id="tabs-3" role="tabpanel">
                                        <div className="product__details__pic__item">
                                            <img src="src/assets/img/shop-details/product-big.png" alt=""/>
                                        </div>
                                    </div>
                                    <div className="tab-pane" id="tabs-4" role="tabpanel">
                                        <div className="product__details__pic__item">
                                            <img src="src/assets/img/shop-details/product-big-4.png" alt=""/>
							...
							backgroundImage:
								"url(src/assets/img/product/product-1.jpg"}}>
                                    ...
                                    <ul className="product__hover">
                                        <li><a href="#"><img src="src/assets/img/icon/heart.png" alt=""/></a></li>
                                        <li><a href="#"><img src="src/assets/img/icon/compare.png" alt=""/> <span>Compare</span></a></li>
                                        <li><a href="#"><img src="src/assets/img/icon/search.png" alt=""/></a></li>
                                    </ul>
                                </div>
